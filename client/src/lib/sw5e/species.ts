  ...
  export const species: Species[] = [
    ...
    }
    {
      ...
      description: "Some Arkanians have a complex history with genetic manipulation and Force sensitivity.",
      abilityScoreIncrease: {
        intelligence: 2,
        any: 1
      },
    ...
    },
    {
      ...
      description: "Their dexterity and luck can make them skilled in various roguish pursuits.",
      abilityScoreIncrease: {
        dexterity: 2,
        charisma: 1
      },
    ...
    },
    {
      id: "barabel",
      name: "Barabel",
      summary: "Fierce and territorial, with a strong connection to their aquatic homeworld.",
     ...
     {
          name: "Powerful Tail",
          description: "Unarmed strikes with tail deal 1d4 bludgeoning, reach 5 ft."
        },
     {
          name: "Swift Swimmer",
    ...
    },
    {
      id: "besalisk",
      name: "Besalisk",
      summary: "Known for their physical strength and often employed in roles requiring heavy lifting or combat.",
      ...
      traits: [
        {
          name: "Four Arms",
          description: "Advantage on Strength (Athletics) checks to grapple, can wield two additional light weapons"
        },
        {
          name: "Powerful Build",
    ...
    },
    {
      id: "bith",
      name: "Bith",
      summary: "Known for their artistic talents, particularly in music and mathematics.",
    ...
    },
    {
      id: "caamasi",
      name: "Caamasi",
      summary: "Wise and contemplative, with exceptional memory and occasional glimpses into the future.",
        ...
        },
     {
          ...
          description: "Can enter a trance to gain insight, providing advantage on one attack roll, ability check, or saving throw per long rest"
        }
      ],
    ...
    },
    {
      id: "cathar",
      name: "Cathar",
      summary: "Fierce warriors and skilled hunters with a strong sense of honor and loyalty.",
    ...
    },
    {
      id: "chadra-fan",
      name: "Chadra-Fan",
      summary: "Agile and resourceful, adapted to living in dense, vertical environments.",
    ...
    },
    {
      id: "chagrian",
      name: "Chagrian",
      summary: "Calm and patient, with a natural affinity for aquatic environments.",
    ...
    }
    {
      id: "chevin",
      name: "Chevin",
      summary: "Physically imposing and resilient, often found in roles requiring strength and endurance.",
      ...
      traits: [
        ...
        },
        {
          ...
          description: "When reduced to 0 HP but not killed, can drop to 1 HP once per long rest"
        }
      ],
    ...
    },
    {
      id: "chiss",
      name: "Chiss",
      summary: "Disciplined and strategic thinkers with a strong emphasis on order and tradition.",
    ...
    },
    {
      ...
      description: "Their shapeshifting abilities make them ideal for espionage and subterfuge. Often viewed with suspicion by other species.",
      abilityScoreIncrease: {
        dexterity: 2,
        charisma: 1
      },
      ...
      traits: [
        {
          name: "Shapechanger",
          description: "As an action, can polymorph into any Medium or Small humanoid they have seen, or back to their true form. Stats remain the same"
        }
      ],
    ...
    },
    {
      id: "codru-ji",
      name: "Codru-Ji",
      summary: "Known for their keen eyesight and often possess a perceptive and observant nature.",
    ...
    },
    {
      id: "colicoid",
      name: "Colicoid",
      summary: "Physically tough and often found in roles requiring strength and resilience.",
    ...
    },
    {
      ...
      description: "Their connection to shadow can make them skilled infiltrators.",
      abilityScoreIncrease: {
        dexterity: 2,
        wisdom: 1
      },
     ...
     {
          name: "Shadowmeld",
          description: "Advantage on Dexterity (Stealth) checks in dim light or darkness"
        },
     {
    ...
    },
    {
      ...
      description: "Their ability to blend into shadows makes them excellent spies or assassins.",
      abilityScoreIncrease: {
        dexterity: 2,
        charisma: 1
      },
    ...
    },
    {
      id: "devaronian",
      name: "Devaronian",
      summary: "Known for their distinctive horns and often seen as charismatic and sometimes hot-headed.",
    ...
    },
    {
      id: "diathim",
      name: "Diathim",
      summary: "Peaceful and empathetic, with a natural ability to sense the emotions of others.",
    ...
    },
    {
     ...
     {
          name: "Constructed",
          description: "Immunity: disease, poison; Resistance: poison; No eat/drink/breathe/sleep; Immune to sleep effects"
        },
     {
    ...
    },
    {
      id: "droid-class-ii",
      name: "Droid, Class II",
      summary: "Versatile utility droids specializing in technical support, navigation, and repair.",
    ...
    },
    {
      ...
      summary: "Designed for leadership, negotiation, or specialized social roles.",
      description: "Often possess advanced communication and analytical capabilities.",
      abilityScoreIncrease: {
        charisma: 2,
        intelligence: 1
      },
        ...
        },
     {
          ...
          description: "Proficiency in Deception, Insight, Intimidation, or Persuasion"
        }
      ],
      languages: ["Galactic Basic", "plus one of choice"],
      source: "PHB",
    ...
    },
    {
      id: "echani",
      name: "Echani",
      summary: "Renowned for their martial arts prowess and disciplined fighting styles.",
    ...
    },
    {
      ...
      description: "Despite their small size, they can be fierce and resourceful.",
      abilityScoreIncrease: {
        dexterity: 2,
        constitution: 1
      },
        ...
        },
     {
          ...
          description: "Advantage on Investigation with simple mechanical devices/traps"
        }
      ],
    ...
    },
    {
      ...
      description: "Known for their alluring presence and diplomatic skills. Their pheromones can subtly influence others.",
      abilityScoreIncrease: {
          charisma: 2,
          constitution: 1
      },
      ...
      traits: [
          {
              ...
              description: "Advantage on Charisma (Persuasion) checks with non-hostile creatures"
          },
          {
  ...
  },
  {
      ...
      description: "Known for their brute strength and often employed as guards or mercenaries. Their society has a strong emphasis on physical prowess.",
      abilityScoreIncrease: {
          strength: 2,
          constitution: 1
      },
  ...
  },
  {
      ...
      description: "Often heavily augmented with cybernetics, reflecting their brutal and survival-oriented culture. Known for their tracking abilities.",
      abilityScoreIncrease: {
          strength: 2,
          dexterity: 1
      },
  ...
  },
  {
    ...
    "description": "Highly intelligent and adapted to the vacuum of space. Often possess a logical and analytical mindset.",
    "abilityScoreIncrease": {
     "intelligence": 2,
     "constitution": 1
    },
    ...
    "traits": [
     ...
     },
     {
      ...
      "description": "Advantage on Intelligence (Investigation) checks related to mathematics or physics"
     }
    ],
    "languages": [
     "Galactic Basic",
   ...
   },
   {
    ...
    "description": "Live in underwater and swampy environments. Their society has a complex hierarchical structure and unique customs.",
    "abilityScoreIncrease": {
     "dexterity": 2,
     "strength": 1
    },
   ...
   },
   {
    "id": "herglic",
    "name": "Herglic",
    "summary": "Large, aquatic species often involved in interstellar transport and trade",
    "description": "Large, aquatic species often involved in interstellar transport and trade. Generally peaceful but can be formidable when provoked.",
    "abilityScoreIncrease": {
     "constitution": 2,
     "strength": 1
    },
   ...
   },
   {
    ...
    "description": "Known for their criminal empires and influence in the Outer Rim. Often seen as cunning and greedy.",
    "abilityScoreIncrease": {
     "constitution": 2,
     "charisma": 1
    },
   ...
   },
   {
    "id": "iktokchi",
    "name": "Iktotchi",
    "summary": "Known for their facial horns and often possess a calm and intuitive nature",
    "description": "Known for their facial horns and often possess a calm and intuitive nature. Their gliding ability is a unique trait.",
    "abilityScoreIncrease": {
     "wisdom": 2,
     "dexterity": 1
    },
   ...
   },
   {
    ...
    "description": "Pacifistic and deeply connected to the natural world. Their society often revolves around preserving and nurturing their environment.",
    "abilityScoreIncrease": {
     "charisma": 2,
     "wisdom": 1
    },
   ...
   },
   {
    "id": "ishi-tib",
    "name": "Ishi Tib",
    "summary": "Require specialized life support out of water for extended periods",
    "description": "Require specialized life support out of water for extended periods. Often possess a studious and thoughtful nature.",
    "abilityScoreIncrease": {
     "constitution": 2,
     "intelligence": 1
    },
   ...
   },
   {
    "id": "jawa",
    "name": "Jawa",
    "summary": "Scavengers and traders known for their skills in repairing and modifying technology",
    "description": "Scavengers and traders known for their skills in repairing and modifying technology. Their society is often secretive and focused on acquiring and trading salvaged goods.",
    "abilityScoreIncrease": {
     "dexterity": 2,
     "intelligence": 1
    },
   ...
   },
   {
    "id": "kaleesh",
    "name": "Kaleesh",
    "summary": "Fierce and independent warriors with a strong sense of honor and tradition",
    "description": "Fierce and independent warriors with a strong sense of honor and tradition. Their masked appearance is a cultural norm.",
    "abilityScoreIncrease": {
     "strength": 2,
     "wisdom": 1
    },
   ...
   },
   {
    "id": "kaminoan",
    "name": "Kaminoan",
    "summary": "Tall, elegant beings known for their cloning technology and scientific expertise",
    "description": "Tall, elegant beings known for their cloning technology and scientific expertise. Their society values logic and precision.",
    "abilityScoreIncrease": {
     "intelligence": 2,
     "dexterity": 1
    },
    ...
    "traits": [
     ...
     {
      "name": "Precise",
      "description": "Advantage on Intelligence (Technology) checks to operate or repair complex devices"
     }
    ],
    "languages": [
     "Galactic Basic",
    ...
    },
   {
    "id": "kel dor",
    "name": "Kel Dor",
    "summary": "Require special breathing masks when in oxygen-rich environments. Known for their strong connection to the Force and often possess a stoic and determined nature.",
    "description": "Require special breathing masks when in oxygen-rich environments. Known for their strong connection to the Force and often possess a stoic and determined nature.",
    "abilityScoreIncrease": {
    "wisdom": 2,
    "dexterity": 1
    },
    ...
    },
   {
    "id": "kel dor, moomin",
    "name": "Kel Dor, Moomin",
    "summary": "Share many traits with standard Kel Dor but with a stronger emphasis on resilience and mental fortitude.",
    "description": "Distinguished by slightly different facial structures and cultural nuances from standard Kel Dor. Share many traits with standard Kel Dor but with a stronger emphasis on resilience and mental fortitude.",
    "abilityScoreIncrease": {
    "wisdom": 2,
    "constitution": 1
    },
    ...
    "description": "Advantage on Wisdom saving throws against mind-altering effects"
    },
    {
    "name": "Vacuum Adaptation",
    "description": "Can breathe in a vacuum"
    ...
    },
   {
    "id": "kubaz",
    "name": "Kubaz",
    "summary": "Insectoid species known for their tracking abilities and sensitivity to bright light",
    "description": "Insectoid species known for their tracking abilities and sensitivity to bright light. Often employed as spies or bounty hunters.",
    "abilityScoreIncrease": {
     "dexterity": 2,
     "intelligence": 1
    },
    ...
    "traits": [
     ...
     },
     {
      ...
      "description": "Disadvantage on saving throws against bright light sources"
     }
    ],
    "languages": [
     "Galactic Basic",
    ...
    },
   {
    "id": "kyuzo",
    "name": "Kyuzo",
    "summary": "Rugged and independent survivalists known for their martial prowess and adaptability to harsh environments",
    "description": "Rugged and independent survivalists known for their martial prowess and adaptability to harsh environments.",
    "abilityScoreIncrease": {
     "dexterity": 2,
     "strength": 1
    },
    ...
    },
   {
    "id": "lannik",
    "name": "Lannik",
    "summary": "Small and agile, often possessing a strong sense of community and resourcefulness",
    "description": "Small and agile, often possessing a strong sense of community and resourcefulness. Their agility makes them adept at evasion.",
    "abilityScoreIncrease": {
     "dexterity": 2,
     "wisdom": 1
    },
    ...
    "traits": [
     ...
     {
      "name": "Resourceful",
      "description": "Proficiency in one of the following: Investigation, Survival, or Technology"
     }
    ],
    "languages": [
     "Galactic Basic",
    ...
    },
   {
    ...
    "description": "Agile and powerful warriors with distinctive physical features. Their prehensile feet provide unique advantages.",
    "abilityScoreIncrease": {
     "strength": 2,
     "dexterity": 1
    },
    ...
    "traits": [
     {
      "name": "Lasat Agility",
      "description": "Advantage on Dexterity (Acrobatics) checks and Dexterity saving throws"
     },
     {
    ...
    },
   {
    ...
    "description": "Generally peaceful and connected to nature. Their camouflage abilities aid in avoiding conflict.",
    "abilityScoreIncrease": {
     "wisdom": 2,
     "dexterity": 1
    },
    ...
    },
   {
    "id": "miralan",
    "name": "Miralan",
    "summary": "Often possess a strong connection to the Force and tend to be intuitive and perceptive",
    "description": "Often possess a strong connection to the Force and tend to be intuitive and perceptive. Their lack of visible eyes is a defining trait.",
    "abilityScoreIncrease": {
     "wisdom": 2,
     "charisma": 1
    },
    ...
    "traits": [
     ...
     {
      "name": "Intuitive",
      "description": "Proficiency in one of the following: Insight or Perception"
     }
    ],
    "languages": [
     "Galactic Basic",
    ...
    },
   {
    "id": "mirialan",
    "name": "Mirialan",
    "summary": "Known for their spiritual traditions and the intricate tattoos that mark their life's achievements",
    "description": "Known for their spiritual traditions and the intricate tattoos that mark their life's achievements. Often possess a disciplined and thoughtful nature.",
    "abilityScoreIncrease": {
     "dexterity": 2,
     "wisdom": 1
    },
    ...
    },
   {
    "id": "mon-calamari",
    "name": "Mon Calamari",
    "summary": "Known for their artistic talents, philosophical nature, and exceptional skills in aquatic engineering and naval strategy",
    "description": "Known for their artistic talents, philosophical nature, and exceptional skills in aquatic engineering and naval strategy. Often possess a calm and diplomatic demeanor.",
    "abilityScoreIncrease": {
     "charisma": 2,
     "intelligence": 1
    },
    ...
    },
   {
    "id": "muun",
    "name": "Muun",
    "summary": "Elegant and highly intelligent beings known for their financial acumen and often involved in banking and commerce",
    "description": "Elegant and highly intelligent beings known for their financial acumen and often involved in banking and commerce. Their telepathic abilities aid in communication.",
    "abilityScoreIncrease": {
     "intelligence": 2,
     "charisma": 1
    },
    ...
    "traits": [
     {
      ...
      "description": "Advantage on Intelligence (Investigation) and Intelligence (Technology) checks"
     },
     {
    ...
    },
   {
    ...
    "description": "Mysterious and often seen as shadowy figures. Their agility and stealth make them formidable assassins or spies.",
    "abilityScoreIncrease": {
     "dexterity": 2,
     "intelligence": 1
    },
    ...
    },
   {
    "id": "nautolan",
    "name": "Nautolan",
    "summary": "Possess a strong connection to the water and often have a calm and perceptive nature",
    "description": "Possess a strong connection to the water and often have a calm and perceptive nature. Their tentacles provide them with unique manipulative abilities.",
    "abilityScoreIncrease": {
     "dexterity": 2,
     "wisdom": 1
    },
    ...
    },
   {
    ...
    "description": "Often seen as cowardly and motivated by profit. Their society has a strong hierarchical structure.",
    "abilityScoreIncrease": {
     "intelligence": 2,
     "charisma": -2
    },
    ...
    "traits": [
     ...
     },
     {
      ...
      "description": "Proficiency in one of the following: Deception, Persuasion, or Insight"
     }
    ],
    "languages": [
     "Galactic Basic",
    ...
    },
   {
    ...
    "description": "Often tribal and known for their hardiness and physical strength. Different sub-species can have varying cultural practices.",
    "abilityScoreIncrease": {
     "strength": 2,
     "constitution": 1
    },
    ...
    "traits": [
     ...
     {
      "name": "Natural Weapons",
      "description": "Choose one: Claws (1d4 slashing) or Horns (1d4 bludgeoning)"
     }
    ],
    "languages": [
     "Galactic Basic",
    ...
    }, 
   {
    "id": "nogri",
    "name": "Nogri",
    "summary": "Small, agile, and stealthy, often employed as assassins or bodyguards",
    "description": "Small, agile, and stealthy, often employed as assassins or bodyguards. Their poisonous barbs make them dangerous in close combat.",
    "abilityScoreIncrease": {
    "dexterity": 2,
    "wisdom": 1
    },
    ...
    },
   {
    "id": "quermian",
    "name": "Quermian",
    "summary": "Tall, intellectual beings with two brains, granting them enhanced cognitive abilities",
    "description": "Tall, intellectual beings with two brains, granting them enhanced cognitive abilities. Their telepathic abilities aid in communication.",
    "abilityScoreIncrease": {
    "intelligence": 2,
    "wisdom": 1
    },
    ...
    "description": "Can communicate telepathically with one willing creature within 30 feet"
    }
    ],
    "languages": [
    "Galactic Basic",
    ...
    },
   {
    "id": "rakatan",
    "name": "Rakatan",
    "summary": "Ancient and powerful Force-sensitive species with a history of a vast empire",
    "description": "Ancient and powerful Force-sensitive species with a history of a vast empire. Sub-species with varying degrees of Force sensitivity and physical characteristics. Often possess a strong connection to technology and the dark side of the Force.",
    "abilityScoreIncrease": {
    "charisma": 2,
    "any one": 1
    },
    ...
    },
   {
    ...
    "description": "Fierce and resilient warriors from a harsh desert world. Often possess a brutal and survival-oriented culture.",
    "abilityScoreIncrease": {
    "strength": 2,
    "constitution": 1
    },
    ...
    },
   {
    "id": "rodian",
    "name": "Rodian",
    "summary": "Known for their hunting prowess and often seen as skilled trackers and bounty hunters",
    "description": "Known for their hunting prowess and often seen as skilled trackers and bounty hunters. Their society can be competitive and focused on the hunt.",
    "abilityScoreIncrease": {
    "dexterity": 2,
    "constitution": 1
    },
    ...
    },
   {
    ...
    "description": "Agile and cooperative, often living in close-knit communities. Their keen sense of smell aids in tracking and social interaction.",
    "abilityScoreIncrease": {
    "dexterity": 2,
    "intelligence": 1
    },
    ...
    {
    "name": "Pack Tactics",
    "description": "Advantage on attack rolls against a creature if at least one of your allies is within 5 feet of the creature and isn't incapacitated"
    }
    ],
    "languages": [
    "Galactic Basic",
    ...
    },
   {
    "id": "sith pureblood",
    "name": "Sith Pureblood",
    "summary": "Descendants of the ancient Sith, often possessing a natural affinity for the dark side of the Force",
    "description": "Descendants of the ancient Sith, often possessing a natural affinity for the dark side of the Force. Their society values power and dominance. Variations in skin pigmentation and facial markings",
    "abilityScoreIncrease": {
    "charisma": 2,
    ...
    },
   {
    "id": "squib",
    "name": "Squib",
    "summary": "Small and resourceful scavengers and traders, similar to Jawas but often more opportunistic",
    "description": "Small and resourceful scavengers and traders, similar to Jawas but often more opportunistic. Known for their tinkering skills.",
    "abilityScoreIncrease": {
    "dexterity": 2,
    "intelligence": 1
    },
    ...
    },
   {
    "id": "togruta",
    "name": "Togruta",
    "summary": "Possess a strong connection to the Force and often exhibit a vibrant and communal culture",
    "description": "Possess a strong connection to the Force and often exhibit a vibrant and communal culture. Their montrals and lekku are sensory organs.",
    "abilityScoreIncrease": {
    "wisdom": 2,
    "strength or dexterity": 1
    },
    ...
    },
   {
    "id": "trandoshan",
    "name": "Trandoshan",
    "summary": "Reptilian humanoids known for their hunting skills and the 'Scorekeeper' system",
    "description": "Reptilian humanoids known for their hunting skills and the 'Scorekeeper' system. Often seen as formidable warriors and bounty hunters.",
    "abilityScoreIncrease": {
    "strength": 2,
    "wisdom": 1
    },
    ...
    },
   {
    "id": "twilek",
    "name": "Twilek",
    "summary": "Known for their grace, charm, and often their roles in entertainment or diplomacy",
    "description": "Known for their grace, charm, and often their roles in entertainment or diplomacy. Their lekku are a significant part of their communication and culture. Numerous color variations indicating heritage (Red, Blue, Green, Yellow, etc.)",
    "abilityScoreIncrease": {
    "charisma": 2,
    "any one": 1
    },
    ...
    {
    "name": "Lekku",
    "description": "Advantage on Wisdom (Insight) and Charisma (Persuasion) checks"
    },
    {
    "name": "Twilek Grace",
    ...
    },
   {
    "id": "verpine",
    "name": "Verpine",
    "summary": "Insectoid species known for their engineering skills and communal society",
    "description": "Insectoid species known for their engineering skills and communal society. Their compound eyes provide excellent vision, and antennae aid in awareness.",
    "abilityScoreIncrease": {
    "intelligence": 2,
    "dexterity": 1
    },
    ...
    },
   {
    ...
    "description": "Highly spiritual and connected to the Living Force. Their society is often divided between mystics and commandos. Voss Mystics, Voss Commandos (cultural/role-based variations)",
    "abilityScoreIncrease": {
    "wisdom": 2,
    "intelligence": 1
    },
    ...
    {
    "name": "Trance",
    "description": "Can enter a meditative trance for 4 hours to gain the benefits of a long rest"
    }
    ],
    "languages": [
    "Galactic Basic",
    ...
    "id": "weequay",
    "name": "Weequay",
    "summary": "Often tribal and known for their resilience and connection to their desert homeworld",
    "description": "Often tribal and known for their resilience and connection to their desert homeworld. Can be seen as gruff or unsophisticated by outsiders.",
    "abilityScoreIncrease": {
    "strength": 2,
    "wisdom": -2
    },
    ...
    {
    "name": "Primitive",
    "description": "Proficiency in one of the following: Animal Handling, Survival, or Athletics"
    }
    ],
    "languages": [
    "Galactic Basic",
    ...
    },
   {
    "id": "whiphid",
    "name": "Whiphid",
    "summary": "Large, fur-covered humanoids known for their strength and tracking abilities",
    "description": "Large, fur-covered humanoids known for their strength and tracking abilities. Their keen sense of smell is a significant asset.",
    "abilityScoreIncrease": {
    "strength": 2,
    "constitution": 1
    },
    ...
    },
   {
    "id": "zabrak",
    "name": "Zabrak",
    "summary": "Known for their distinctive horns and often possess a strong will and independent spirit",
    "description": "Known for their distinctive horns and often possess a strong will and independent spirit. Different homeworlds can lead to cultural variations. Dathomirian Zabrak (often more agile and stealthy), Iridonian Zabrak (more balanced)",
    "abilityScoreIncrease": {
    "any two": 1,
    "or one": 2,
    "and one": 1
    ...
    "description": "Once per short or long rest, when you are reduced to 0 hit points but not killed outright, you can drop to 1 hit point instead"
    }
    ],
    "languages": [
    "Galactic Basic",
