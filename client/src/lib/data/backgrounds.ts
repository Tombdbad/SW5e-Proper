...
export const backgrounds: BackgroundData[] = [
  {
    id: "ace_pilot",
    name: "Ace Pilot",
    description: "You are a skilled and daring pilot, known for your exceptional abilities behind the controls of starships and other vehicles. Your reputation has been built on successful flights through asteroid fields, combat engagements, or high-stakes racing.",
    ...
    feature: {
      ...
      description: "You're familiar with most vehicles and can apply your expertise across different makes and models. When you encounter a new vehicle, you can determine its basic capabilities, systems, and potential flaws with a quick inspection. Additionally, your reputation as a pilot gives you access to piloting clubs, racetracks, and similar establishments where you can potentially borrow vehicles, get information, or find work."
    },
    suggestedCharacteristics: {
      personalityTraits: [
  ...
  },
  {
    id: "bounty_hunter",
    name: "Bounty Hunter",
    description: "You make your living tracking down and capturing or killing targets for credits. Whether you're motivated by justice, profit, or thrill of the hunt, you've developed a particular set of skills that makes you effective at finding those who don't want to be found.",
    ...
    feature: {
      ...
      description: "You have a contact within a bounty hunting guild or network who can provide you with information about available bounties in the region. Additionally, you can identify the signs that someone has a bounty on them, and you know the general protocols for turning in bounties in most major systems."
    },
    suggestedCharacteristics: {
      personalityTraits: [
  ...
  },
  {
    id: "criminal",
    name: "Criminal",
    description: "You have a history of breaking the law and living outside society's rules. Whether you were a professional thief, smuggler, or enforcer for a crime syndicate, you know how the criminal underworld operates.",
    ...
    feature: {
      ...
      description: "You have a reliable contact who acts as your connection to a criminal network. You know how to get messages to and from this contact, even in remote regions, and you can call upon them for information or arrangements for low-level criminal services."
    },
    variants: [
      {
        id: "smuggler",
        name: "Smuggler",
        description: "You specialize in moving illegal or regulated goods past authorities, knowing the best routes and methods to avoid detection.",
        skillProficiencies: ["Deception", "Piloting"]
      },
      {
        id: "spy",
        name: "Spy",
        description: "You gathered information for a government, corporation, or criminal organization, developing skills in subterfuge and intelligence gathering.",
  ...
  },
  {
    id: "force_adept",
    name: "Force Adept",
    description: "You received training in the ways of the Force from an unorthodox source—perhaps an isolated temple, a secretive order neither Jedi nor Sith, or a culture that has its own traditions of Force use. Your connection to the Force shapes your worldview and abilities.",
    ...
    feature: {
      ...
      description: "You can sense disturbances in the Force and have intuitions about people, places, or objects that others might miss. Additionally, you know obscure knowledge about Force traditions and can identify Force-related artifacts or locations with greater ease than most."
    },
    suggestedCharacteristics: {
      personalityTraits: [
  ...
  },
  {
    id: "scholar",
    name: "Scholar",
    description: "You've spent years studying in archives, universities, or private collections, becoming an expert in a particular field of knowledge. Your academic background has given you insight into a wide range of subjects and analytical skills that others lack.",
    ...
    feature: {
      ...
      description: "You have access to libraries, universities, and scholarly networks throughout the galaxy. You can leverage these connections to research information, gain entry to restricted archives, or find expert consultation on obscure topics. Fellow scholars are generally willing to assist you as a professional courtesy, expecting similar aid in return."
    },
    variants: [
      {
        id: "archaeologist",
        name: "Archaeologist",
        description: "You specialize in uncovering and preserving the physical remains of ancient civilizations, particularly those with connections to the Force or forgotten technologies.",
        skillProficiencies: ["Athletics", "Lore"]
      },
      {
        id: "scientist",
        name: "Scientist",
        description: "You are trained in scientific methodology and research, focusing on fields like xenobiology, astrophysics, or advanced technology.",
  ...
  },
  {
    id: "soldier",
    name: "Soldier",
    description: "You have served in a military organization, whether a planetary defense force, a mercenary company, or a galactic power's army. Your experience has made you tough, disciplined, and skilled in combat tactics.",
    ...
    feature: {
      name: "Military Rank",
      description: "You hold a military rank from your previous service. Soldiers loyal to your former military organization still recognize your authority and influence, and they defer to you if they are of a lower rank. You can invoke your rank to exert influence over other soldiers and requisition simple equipment or horses for temporary use. You can also usually gain access to friendly military encampments and fortresses where your rank is recognized."
    },
    variants: [
      {
        id: "medic",
        name: "Medic",
        description: "You served as a battlefield medic, treating wounds and saving lives under fire.",
        skillProficiencies: ["Medicine", "Insight"]
      },
      {
        id: "officer",
        name: "Officer",
        description: "You served as a commissioned officer, leading troops and making strategic decisions.",
