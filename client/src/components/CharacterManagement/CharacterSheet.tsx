                                  ...
                                  <Card className="bg-gray-700">
                                    <CardHeader className="flex flex-row items-center justify-between">
                                      ...
                                      {character.forceAlignment && (
                                        <Badge 
                                          variant="outline" 
                                          className={character.forceAlignment.toLowerCase() === "light" ? "bg-blue-900/30" : 
                                                    character.forceAlignment.toLowerCase() === "dark" ? "bg-red-900/30" : 
                                                    "bg-gray-800"}
                                        >
                                      ...
                                      <div className="space-y-4">
                                        <div className="bg-gray-800 p-4 rounded-lg">
                                          ...
                                          <div className="flex items-center space-x-2">
                                            ...
                                            <div className="text-lg font-bold">{character.currentForcePoints}/{character.maxForcePoints}</div>
                                          </div>
                                          <div className="text-sm mt-2">
                                            Force points are used to cast force powers. They recover after a long rest.
                                          </div>
                                        </div>
